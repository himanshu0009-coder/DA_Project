...
-- Q2 which customer used a discount but still spent more than the average purchae amount
...
from customerhrome_type
group by customer_segment

-- Q8 what are the top three most product within each category 
with item_counts as (
select category ,
 item_purchased,
...
select item_rank , category , item_pruchased , total_orders
from item_counts
where item_rank <=3;
